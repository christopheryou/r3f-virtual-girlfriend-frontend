...
export function Avatar(props) {
  ...
  const { nodes, materials } = useGLTF("/models/chris.glb");
  const { animations: idleAnimation } = useFBX("/models/animations/Idle.fbx");
  const { animations: talkingAnimation } = useFBX(
    "/models/animations/Talking_1.fbx"
  );
  const { animations: backflipAnimation } = useFBX(
    "models/animations/Backflip.fbx"
  );

  idleAnimation[0].name = "Idle";
  talkingAnimation[0].name = "Angry";
  backflipAnimation[0].name = "Greeting";
...
useGLTF.preload("/models/chris.glb");